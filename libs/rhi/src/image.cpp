	...
	VkImageViewType type)
{
	...
	VK_CHECK_DEVICE(vkCreateImageView(device.device, &vci, nullptr, &view.vkhandle));
...
void Device::destroy_image(Handle<Image> image_handle)
{
	...
	this->vk->vkDestroyImageView(device, image.full_view.vkhandle, nullptr);
