...
struct GenericImporter
{
    ...
    Result<Asset*> import(AssetManager* m, exo::UUID r, const void* d, usize s, void* i) { return value_accessor->import(m, r, d, s, i); }
...
private:
    ...
    struct wrapper final : model
    {
        ...
        Result<Asset*> import(AssetManager* m, exo::UUID r, const void* d, usize s, void* i) final { return value.import(m, r, d, s, i); }
