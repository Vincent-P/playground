...
concept ImporterConcept = requires(T importer)
{
    ...
    { importer.import((AssetManager*)nullptr, cross::UUID{}, (const void*)nullptr, (usize)0, (void*)nullptr)} -> std::same_as<Result<Asset*>>;
...
struct GenericImporter
{
    ...
    Result<Asset*> import(AssetManager* m, cross::UUID r, const void* d, usize s, void* i) { return value_accessor->import(m, r, d, s, i); }
...
private:
    struct model
    {
        ...
        virtual Result<Asset*> import(AssetManager*, cross::UUID, const void*, usize, void*) = 0;
    ...
    struct wrapper final : model
    {
        ...
        Result<Asset*> import(AssetManager* m, cross::UUID r, const void* d, usize s, void* i) final { return value.import(m, r, d, s, i); }
