...
Renderer::GltfPass create_gltf_pass(RenderGraph &graph, vulkan::API &api, std::shared_ptr<Model> &_model)
{
    ...
    pass.material = Material{{
        ...
        .depth         = {VK_COMPARE_OP_EQUAL, false},
    }};

    // override for each pass
    pass.material["shading"]        = {.fragment_shader = api.create_shader("shaders/gltf.frag.spv")};
    pass.material["shading-simple"] = {.fragment_shader = api.create_shader("shaders/gltf_sample.frag.spv")};
    pass.material["prepass"]        = {
        .fragment_shader = api.create_shader("shaders/gltf.frag.spv"),
        .depth = {VK_COMPARE_OP_GREATER_OR_EQUAL, true},
    };

    auto &technique = pass.material["shading"];
    #endif
