...
namespace my_app
{
    float TimerData::get_time() const
    {
        return float_time;
    }

    float TimerData::get_delta_time() const
    {
        return float_delta_time;
    }

    float TimerData::get_average_delta_time() const
    {
        return average_delta_time;
    }

    std::array<float, 10> const& TimerData::get_delta_time_histogram() const
    {
        return delta_time_histogram;
    }

    float TimerData::get_average_fps() const
    {
        return average_fps;
    }

    std::array<float, 10> const& TimerData::get_fps_histogram() const
    {
        return fps_histogram;
    }
