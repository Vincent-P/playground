...
template <typename T>
void serialize_impl(Serializer *serializer, T &data) { serializer_read_or_write(serializer, &data, sizeof(T));}
...
void Serializer::serialize(exo::float4x4 &data) { return serialize_impl(this, data); }
