...
BuddyAllocator BuddyAllocator::create(u32 capacity)
{
    assert(std::has_single_bit(capacity));

    BuddyAllocator allocator = {};
    allocator.capacity       = capacity;
    allocator.levels_count   = std::countr_zero(capacity / LEAF_SIZE) + 1;
...
**/
u32 BuddyAllocator::allocate_block(u32 size, u32 level)
{
...
u32 BuddyAllocator::allocate(u32 size)
{
