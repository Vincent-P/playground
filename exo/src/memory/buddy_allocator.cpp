...
namespace exo
{
static u32 total_size(u32 levels_count) { return (1 << (levels_count - 1)) * LEAF_SIZE; }

static u32 blocks_in_level(u32 level) { return (1 << level); }
...
static u32 block_unique_index(u32 index_in_level, u32 level) { return blocks_in_level(level) - 1 + index_in_level; }
