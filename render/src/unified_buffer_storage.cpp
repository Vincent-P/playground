...
UnifiedBufferStorage UnifiedBufferStorage::create(
	gfx::Device &device, std::string name, usize size_in_bytes, u32 element_size, u32 gpu_usage)
{
...
void UnifiedBufferStorage::free(u32 offset) { allocator.free(offset); }
