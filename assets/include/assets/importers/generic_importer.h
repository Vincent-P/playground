...
concept ImporterConcept = requires(T importer)
{
    ...
    { importer.import((AssetManager*)nullptr, exo::UUID{}, (const void*)nullptr, (usize)0, (void*)nullptr)} -> std::same_as<Result<Asset*>>;
...
struct GenericImporter
{
	...
	Result<Asset *> import(AssetManager *m, exo::UUID r, const void *d, usize s, void *i)
	{
		return value_accessor->import(m, r, d, s, i);
	}
	...
	{
		value_accessor->write_data_json(writer, data);
	}
...
private:
	struct model
	{
		...
		virtual Result<Asset *> import(AssetManager *, exo::UUID, const void *, usize, void *) = 0;
		virtual void           *create_default_importer_data()                                 = 0;
		virtual void           *read_data_json(const rapidjson::Value &j_data)                 = 0;
		virtual void            write_data_json(rapidjson::GenericPrettyWriter<rapidjson::FileWriteStream> &writer,
					   const void                                                                          *data)                                                       = 0;
	};

	template <ImporterConcept T> struct wrapper final : model
	{
		...
		void write_data_json(rapidjson::GenericPrettyWriter<rapidjson::FileWriteStream> &writer, const void *data) final
		{
			value.write_data_json(writer, data);
		}
